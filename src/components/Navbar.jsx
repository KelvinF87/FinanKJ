...
const navigation = [
  ...
  { name: 'Ingresos', href: '/ingreso', current: false, icon: <CircleDollarSign/>},
  { name: 'Gastos', href: '#', current: false, icon: <Receipt /> },
  { name: 'Configuracion', href: '#', current: false, icon: <Settings /> },
];
